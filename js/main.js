...
$(document).ready(function() {
  ...
  $("#locationBtn").on("click", function(e) {
    ...
    if (value === "") {
      ...
      url = "https://api.openweathermap.org/data/2.5/weather?q=" + value + "&appid=99ccd40e0a5fc26b95eb7d6d3ebeacd7&units=metric";
      getData();
    }
...
function showPosition(pos) {
  ...
  url = "https://api.openweathermap.org/data/2.5/weather?lat=" + lat + "&lon=" + long + "&appid=99ccd40e0a5fc26b95eb7d6d3ebeacd7&units=metric";
  getData();
}
